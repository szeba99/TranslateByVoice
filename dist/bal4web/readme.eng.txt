Balabolka (Command Line Utility for Online Text-To-Speech Using), version 1.32
...
-g <gender>
   ...
   This paratmeter is supported by services: Google TTS, Amazon Polly, IBM Watson TTS, Microsoft Azure.

-n <voice_name>
   Sets the voice name for the online TTS service (if supported). The default value is not defined.
   This paratmeter is supported by services Amazon Polly, IBM Watson TTS, Microsoft Azure.
...
--sub-fit or -sf
   ...
   This paratmeter is supported by services Google TTS and Naver TTS.
